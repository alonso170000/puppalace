...
<header>
    ...
    <nav>
        ...
        <a href="#" id="perfilBtn">Perfil</a> <!-- Botón para desplegar perfil -->
    </nav>
</header>
...
<div id="contacto" class="section">
    <div class="container">
        <form action="add_comentario.php" method="POST" class="form-container">
            <h2>Contáctanos</h2>
...
<!-- Recuadro de Perfil -->
<div id="perfilCard" class="perfil-card" style="display: none;">
    <h2>Perfil</h2>
    ...
    <a href="administracion.html" class="perfil-btn">Cambiar Contraseña</a>
    <hr> <!-- Línea divisoria -->
    <a href="login.php"><button class="cerrar-btn">Cerrar sesión</button></a>
</div>

<script>
    // Mostrar/ocultar el recuadro del perfil
